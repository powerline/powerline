...
class Repository(object):
	...
	def status(self, path=None):
		...
		With file argument: returns status of this file:
		    "M"odified, "A"dded, "R"emoved, "D"eleted (removed from filesystem, 
		    but still tracked), "U"nknown, "I"gnored, (None)Clean.
		'''
		repo = self._repo()
